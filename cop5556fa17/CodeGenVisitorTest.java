...
public class CodeGenVisitorTest implements ImageResources{
	 ...
	 * @throws Exception
	 */
	public void imageFailed1() throws Exception{
		devel = false;
		grade = true;
		String prog = "image1";
		String input =  "image1//args: <imageURL>\nimage g; \ng <- @ 0;\ng -> SCREEN;\n";
	 ...
	 * @throws Exception
	 */
	public void imageFailed2() throws Exception{
		devel = false;
		grade = true;
		String prog = "image5";
	 ...
	 * @throws Exception
	 */
	public void imageFailed3() throws Exception{
		devel = false;
		grade = true;
		String prog = "image6";
		...
		for (int y = 0; y < 1024; y++) {
			for (int x = 0; x < 1024; x++) {
				ImageSupport.setPixel((ImageSupport.getPixel(loggedImage0, x, y) ^ Integer.MAX_VALUE)*3, test, x, y);
				int pixel1 = ImageSupport.getPixel(test, x, y);
				int pixel2 = ImageSupport.getPixel(loggedImage2, x, y);
				assertEquals(pixel1, pixel2);
			}
		}
		keepFrame();
	 ...
	 * @throws Exception
	 */
	public void imageFailed4() throws Exception{
		devel = false;
		grade = true;
		String prog = "image7";
	 ...
	 * @throws Exception
	 */
	public void imageFailed5() throws Exception{
		devel = false;
		grade = true;
	 ...
	 * @throws Exception
	 */
	public void imageFailed6() throws Exception{
		devel = false;
		grade = true;
